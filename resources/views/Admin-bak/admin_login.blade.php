    ...
    <body id="page-top">
        ...
        <!-- wrapper -->
          <div class="wrapper without_header_sidebar">
            ...
            <!-- Start Show Message -->
                            @if (Session::has('error'))   <!-- This error word was delare in admin middleware -->
            ...
            <!-- End Show Message -->
                            ...
                            <form action="{{ route('admin.login') }}" class="d-block" method="post">
                                ...
                                <div class="form-group icon_parent">
                                    ...
                                    <input id="email" type="email" class="form-control"  name="email" autocomplete="email" autofocus placeholder="Email Address">
